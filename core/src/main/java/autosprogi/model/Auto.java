...
public class Auto {
    ...
    public Auto(String marka, String tipus, String rendszam, LocalDate uzembehelyezes_datuma, int loero, int suly,
                int ajtok_szama, int ulesek_szama, int kerek_atmero, int evjarat, String szinkod, Allapot allapot)
                throws RosszDatum, RosszRendszam, RosszEvjarat {
        this.marka = marka;
        this.tipus = tipus;
